...
- Variáveis e Operadores: Utilizados para gerenciar o estado do herói e cálculos de nível.

- Laços de Repetição: Implementado um for no arquivo principal para simular a progressão de turnos e ganho de XP.

- Estruturas de Decisão: Uso de if/else if complexos para validar classe e nível simultaneamente.

- Funções: Criação de funções específicas para processar a lógica de recompensas.

- Classes e Objetos: Definição da classe Heroi para instanciar personagens de forma organizada.
